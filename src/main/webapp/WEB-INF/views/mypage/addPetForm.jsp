        	...
        	<div class="mypage_content">
            	...
            	<div class="form-section">
                	<form action="${contextPath}/mypage/addPet.do" method="post">
                    	...
                    	<div class="form-group">
                        	<label for="pet_species">반려동물 종류</label>
                    	...
                    	<div class="form-group">
                        	...
                        	<div class="gender-options">
                            	<label><input type="radio" name="pet_gender" value="남아" required> 남아</label>
                            	<label><input type="radio" name="pet_gender" value="여아" required> 여아</label>
                        	</div>
                    	</div>
                    	<div class="form-group">
