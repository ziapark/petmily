	...
	<div class="container text-center mt-3 mb-3">
		...
		<table class="table">
			<c:if test="${not empty sessionScope.memberInfo}">
			  	<tr>
			    	<td>이메일</td>
			    	<td><strong>${sessionScope.memberInfo.email1 }@${sessionScope.memberInfo.email2}</strong></td>
			   	</tr>
			   	<tr>
				    <td>전화번호</td>
				    <td>
			   	...
			   	<tr>
			    	...
			    	<td>
						...
						지번 &nbsp;&nbsp; <strong>${sessionScope.memberInfo.jibunAddress}</strong><br>
						상세 주소 &nbsp;&nbsp; <strong>${sessionScope.memberInfo.namujiAddress}</strong><br>
			   		</td>
			   	</tr>
		   	</c:if>
		</table>
