...
<c:set var="goodsListByCategory"  value="${goodsListByCategory}" /> 
	        			...
	        			<div class="col">
	          				<div class="goods-item">
	            				<a href="${contextPath}/goods/goodsDetail.do?goods_num=${goods.goods_num}">
	              					<img src="${contextPath}/download.do?goods_num=${goods.goods_num}&fileName=${goods.fileName}" alt="대표 이미지" />
	            				</a>
	            				...
	            				<div class="cartAndLike_wrap">
				  					...
				  					<input type="button" class="like_icon_btn ${liked ? 'like_on' : 'like_off'}" data-goods-num="${goods.goods_num}" onclick="toggleLikeGoods(this)" />
	            				</div>
	          				</div>
	        			</div>
	      			</c:forEach>
