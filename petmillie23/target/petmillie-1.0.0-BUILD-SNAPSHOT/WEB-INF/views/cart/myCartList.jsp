						...
						<c:forEach var="item" items="${myGoodsList }" varStatus="cnt">
							...
							<td>
								<input type="text" id="cart_goods_qty" name="cart_goods_qty" size="3"
									value="${empty cart_goods_qty || cart_goods_qty == 0 ? 1 : cart_goods_qty}">
								<a href="javascript:modify_cart_qty(${item.goods_num },${item.goods_sales_price} ,${cnt.count-1 });">
		...
		<tr cellpadding=40 align=center>
			...
			<td>
				<p id="p_totalGoodsPrice">
					<fmt:formatNumber value="${totalGoodsPrice}" type="number" var="total_goods_sales_price" />
					${total_goods_sales_price}원
				</p> 
